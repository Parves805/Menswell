...
export function QuickCheckoutDialog({ isOpen, onOpenChange, item }: QuickCheckoutDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="max-h-[90vh] w-[95vw] max-w-4xl p-0 flex flex-col sm:grid sm:grid-cols-2">
            ...
            <div className="p-6 bg-muted/50 order-1 sm:order-2 flex flex-col">
