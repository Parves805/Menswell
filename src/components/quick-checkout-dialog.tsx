...
export function QuickCheckoutDialog({ isOpen, onOpenChange, item }: QuickCheckoutDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="max-h-[90vh] w-[95vw] max-w-4xl p-0 flex flex-col sm:grid sm:grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-6 order-2 sm:order-1">
                ...
                <ScrollArea className="h-full max-h-[calc(90vh-200px)] pr-4 -mr-4">
                    <Form {...form}>
                ...
                <DialogFooter className="p-6 pt-0 sm:hidden">
            ...
            <div className="p-6 bg-muted/50 order-1 sm:order-2 hidden sm:flex flex-col">
