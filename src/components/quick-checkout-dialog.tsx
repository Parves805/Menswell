...
export function QuickCheckoutDialog({ isOpen, onOpenChange, item }: QuickCheckoutDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
        <DialogContent className="max-h-[90vh] w-[95vw] max-w-lg p-0">
          <ScrollArea className="h-full">
            <div className="p-6">
                <DialogHeader className="mb-4 pr-8">
                    <DialogTitle className="text-2xl font-headline">Quick Checkout</DialogTitle>
                </DialogHeader>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Separator />
                                <div className="flex justify-between font-bold text-lg"><span>সর্বমোট</span><span>৳{total.toLocaleString('en-IN')}</span></div>
                            </div>
                        </CardContent>
                    </Card>
            ...
            <DialogFooter className="p-6 pt-2 bg-background sticky bottom-0">
